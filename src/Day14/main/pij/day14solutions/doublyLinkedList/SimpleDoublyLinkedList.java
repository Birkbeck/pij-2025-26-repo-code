 ...
 */
public class SimpleDoublyLinkedList<E> implements SimpleList<E> {
     ...
     */
    public SimpleDoublyLinkedList(List<? extends E> copyMe) {
        int i = 0; // current position in this list
        for (E data : copyMe) {
     ...
     */
    public SimpleDoublyLinkedList(SimpleList<? extends E> copyMe) {
     ...
     * @throws NullPointerException if copyMe is the null reference
     */
    public SimpleDoublyLinkedList(SimpleDoublyLinkedList<? extends E> copyMe) {
