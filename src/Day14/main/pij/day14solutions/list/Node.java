...
/**
 * A node for a generic singly-linked list with a data element and a pointer
 * to the next node. Class has package-private visibility to indicate that
 * it is solely for internal use in the package.
 *
...
class Node<E> {
     ...
     */
    public static <E> Node<E> createSelfLoop() {
