package pij.day15solutions.hailstone;
...
public class Hailstone {
    ...
    public static List<BigInteger> hailstoneRedux(BigInteger n) {
        // The implementation is pretty much the same as for the method
        // that uses int instead of BigInteger. The main difference is
        // that BigInteger does not have any predefined operators for
        // arithmetic operations, so we need to call methods instead.
        // This leads to slightly more verbose-looking code.
