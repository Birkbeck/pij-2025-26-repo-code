...
public class FibonacciExecutorServiceDriver {
    ...
    public static void exerciseExecutorService() {
        // Since Java 19: ExecutorService extends AutoCloseable, and
        // we do not have to call the shutdown() method ourselves
        ...
        // No longer needed:
        // call to shutdown the service so that the JVM can finish
        //service.shutdown();
    }
