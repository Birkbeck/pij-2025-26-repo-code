package pij.day09solutions.point;
...
public class Point implements Comparable<Point> {
    ...
    public boolean equals(Object obj) {
        // VERY IMPORTANT: do *not* write
        //     public boolean equals(Point p)
        // here. Then the method equals(Object) from class Object is not
        // overridden! Method ArrayList.contains (and many other methods from
        // the Java API) will call equals(Object) rather than equals(Point).
        // To make sure that you really override a method, add the "@Override"
        // annotation as above: then the Java compiler will complain if you
        // are not overriding (e.g., because you are using a different method
        // signature).
