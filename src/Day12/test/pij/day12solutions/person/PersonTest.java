package pij.day12solutions.person;

import org.junit.jupiter.api.Test;

// Uncomment the import in the next line to see the failing test!
//import pij.day12.person.Person;
...
public class PersonTest {
    ...
    public void testGetInitials_TwoWordName() {
        ...
        String expected = "TS";
        assertEquals(expected, actual,  // expected BEFORE actual
                "two-word name, single space separator");
    }
    ...
    @Test
    public void testGetInitials_TwoWordNameTwoSpaces() {
        String input = "Jane  Doe";
        Person p = new Person(input);
        String actual = p.getInitials();
        String expected = "JD";
        assertEquals(expected, actual,  // expected BEFORE actual
                "two-word name, two spaces as separator");
    }
