...
// This is the version of CashRegister based on v08, but additionally
// allowing all the tests in v09/CashRegisterTest to pass.
...
public class CashRegister {
    ...
    // getNumberOfCompletedSales() requires an extra counter...

    private int numberOfCompletedSales;

    // ...and getTotalAmountInPenceOfCompletedSales() requires a running total

    private int totalAmountInPenceOfCompletedSales;
    ...
    public int completeSale() {
        ...
        numberOfCompletedSales++;
        totalAmountInPenceOfCompletedSales += result;
        return result;
    }
    ...
    public int getTotalAmountInPenceOfCompletedSales() {
        return totalAmountInPenceOfCompletedSales;
    }
}
