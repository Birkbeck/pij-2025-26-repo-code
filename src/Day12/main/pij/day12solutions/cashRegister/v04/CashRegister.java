package pij.day12solutions.cashRegister.v04;

// This is the version of CashRegister based on v03, but additionally
// allowing all the tests in v04/CashRegisterTest to pass.
...
public class CashRegister {
    ...
    private int numberOfItemsCurrentSale;
    private int totalAmountCurrentSale;

    /**
     * Initialises a new CashRegister without any prior items and sales.
     */
    public CashRegister() {
        // constructor body is deliberately empty at this stage because the
        // default values of the fields are the values that we want
        // (so we might even remove the constructor for now)
    }
    ...
    public void addItem(int priceInPence) {
        ...
        numberOfItemsCurrentSale++;
        totalAmountCurrentSale += priceInPence;
    }
    ...
    public int numberOfItemsInCurrentSale() {
        return numberOfItemsCurrentSale;
    }
